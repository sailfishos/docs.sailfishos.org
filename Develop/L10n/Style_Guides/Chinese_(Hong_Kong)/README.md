...
Please see the table below for UI reference format (adapted to Chinese (Hong Kong) from the following source: <http://www.ccjk.com/common-rule-on-translation>):
