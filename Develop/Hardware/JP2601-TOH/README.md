...
<!-- TODO: Insert some schematics for the circuits -->
...
To facilitate that some ID resistor values have been assigned to certain types of I²C chips.
...
<!-- TODO: ID resistor values and matching memory chip types to be added -->

A TOH with a microcontroller unit may emulate a memory chip at address 0x50.
...
| Name         | Size     | Value |
|--------------|----------|-------|
| Magic        | 4 bytes  | 0x4A, 0x54, 0x4F, 0x48 |
| Checksum     | 4 bytes  | CRC-32 of the following memory content until the end of the payload. |
| Vendor ID    | 2 bytes  | Vendor specific ID |
| Product ID   | 2 bytes  | Vendor chosen product ID |
| Reserved     | 2 bytes  | 0x00, 0x00 |
| Payload size | 2 bytes  | Size of payload in bytes |
| Payload data | Variable | CBOR data |
...
<!-- TODO: Add a description of the expected payload content, e.g. keys to be found in the data -->
