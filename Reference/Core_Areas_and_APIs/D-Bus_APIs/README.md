...
Introspection is easiest with `qdbus` command. That command is found on Sailfish OS in the *qt5-qttools-qdbus* package with the binary located at `/usr/lib/qt5/bin/qdbus` or `/usr/lib64/qt5/bin/qdbus`.
