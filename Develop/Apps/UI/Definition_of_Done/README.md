...
## Further recommendations
  ...
  - Unless you have done already read all the [Qt Quick documentation](https://doc.qt.io/archives/qt-5.6/qtquick-index.html) you find in the Qt documentation pages.
  - Read official [Qt performance documentation](https://doc.qt.io/archives/qt-5.6/qtquick-performance.html). Tomorrow read it again. Also KDAB Qt Partner has also written few excellent posts about [QML engine internals](http://www.kdab.com/category/blogs/qmlengineseries).
